                    ...
                    <div className={`overflow-y-auto overflow-x-hidden flex-grow lg:block xl:block bg-gray-800`}>
                        {isMenuOpen &&
                            <ul className="flex flex-col py-4 space-y-1">
                                ...
                                <li>
                                    <Link href="/clubincharge/createEvents" className="relative flex flex-row items-center h-11 focus:outline-none hover:bg-gray-700 text-gray-300 hover:text-white border-l-4 border-transparent hover:border-indigo-500 pr-6 rounded-md">
                                ...
                                <li>
                                    <Link href="/clubincharge/viewEvents" className="relative flex flex-row items-center h-11 focus:outline-none hover:bg-gray-700 text-gray-300 hover:text-white border-l-4 border-transparent hover:border-indigo-500 pr-6 rounded-md">
                                        <span className="inline-flex justify-center items-center ml-4">
                                            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 13V6a2 2 0 00-2-2H6a2 2 0 00-2 2v7m16 0v5a2 2 0 01-2 2H6a2 2 0 01-2-2v-5m16 0h-2.586a1 1 0 00-.707.293l-2.414 2.414a1 1 0 01-.707.293h-3.172a1 1 0 01-.707-.293l-2.414-2.414A1 1 0 006.586 13H4"></path></svg>
                                        </span>
                                        <span className="ml-2 text-sm tracking-wide truncate">View Events</span>
                                    </Link>
                                </li>
                                <li>
                                    <Link href="/clubincharge/registeredEvents" className="relative flex flex-row items-center h-11 focus:outline-none hover:bg-gray-700 text-gray-300 hover:text-white border-l-4 border-transparent hover:border-indigo-500 pr-6 rounded-md">
                                        <span className="inline-flex justify-center items-center ml-4">
                                        ...
                                        <span className="ml-2 text-sm tracking-wide truncate">Registered Events</span>
                                    </Link>
                                </li>
                                <li className="px-5">
                                    <div className="flex flex-row items-center h-8">
                                ...
                                <li>
                                    <Link href="/clubincharge/profile" className='relative flex flex-row items-center h-11 focus:outline-none hover:bg-gray-700 text-gray-300 hover:text-white border-l-4 border-transparent hover:border-indigo-500 pr-6 rounded-md' >
                                        <span className="inline-flex justify-center items-center ml-4">
