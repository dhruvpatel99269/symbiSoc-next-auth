                    ...
                    <div className={`overflow-y-auto overflow-x-hidden flex-grow lg:block xl:block bg-gray-800`}>
                        {isMenuOpen &&
                            <ul className="flex flex-col py-4 space-y-1">
                                ...
                                <li>
                                    <Link href="/student/viewEvents" className="relative flex flex-row items-center h-11 focus:outline-none hover:bg-gray-700 text-gray-300 hover:text-white border-l-4 border-transparent hover:border-indigo-500 pr-6 rounded-md">
                                ...
                                <li>
                                    <Link href="/student/registeredEvents" className="relative flex flex-row items-center h-11 focus:outline-none hover:bg-gray-700 text-gray-300 hover:text-white border-l-4 border-transparent hover:border-indigo-500 pr-6 rounded-md">
                                        <span className="inline-flex justify-center items-center ml-4">
                                ...
                                <li>
                                    <Link href="/student/profile" className='relative flex flex-row items-center h-11 focus:outline-none hover:bg-gray-700 text-gray-300 hover:text-white border-l-4 border-transparent hover:border-indigo-500 pr-6 rounded-md' >
                                        <span className="inline-flex justify-center items-center ml-4">
